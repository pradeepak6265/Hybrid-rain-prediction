...
# आपकी API Key और URL यहाँ जोड़ें
OPENWEATHERMAP_API_KEY = "8fca9ec9c1971957c2a1c12c4403c205"
GOOGLE_SHEETS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbwTXjUHCKOXtHEZfENwdPMIYGba-W_WcvNsKAGWuIjc1PtHzfZ_6u6aFgOyMZ8rL4q4/exec"
CITY = "Jabalpur"
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            # Fetch API data in a loop to ensure it's fresh
            api_data = get_weather_data(OPENWEATHERMAP_API_KEY, CITY)
            
            # Use a short loop to wait for a new MQTT message
            ...
            if latest_sensor_data and api_data:
                ...
                latest_sensor_data = None # Reset for the next cycle
            else:
